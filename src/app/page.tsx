...
const principles = [
  [
    "Secure by design",
    "Supabase authentication and server-enforced access keep identity and application roles separate.",
  ],
  [
    "Care that can travel",
    "Schedule online consultations with verified doctors and avoid unnecessary hospital visits.",
  ],
  [
    "People remain in control",
    "MediSync supports healthcare professionals; it does not replace clinical judgement.",
  ],
];
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.08fr_.92fr] lg:items-center lg:px-8 lg:py-28">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
            MediSync is a secure online patient-care platform where patients can
            find verified doctors and request scheduled online consultations.
            Future clinical tools will be introduced in clearly defined phases.
          </p>
          <div className="mt-9 flex flex-wrap gap-3">
            ...
            <Link
              className="rounded-xl border border-slate-300 bg-white px-6 py-3.5 text-sm font-semibold text-slate-700 hover:border-slate-400"
              href="/login"
            >
              Sign in securely
            </Link>
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-teal-100 bg-slate-950 p-8 text-white shadow-2xl shadow-teal-950/10 sm:p-10">
          ...
          <p className="relative text-xs font-bold uppercase tracking-[0.18em] text-teal-300">
            Secure care foundation
          </p>
          <h2 className="relative mt-4 text-3xl font-semibold tracking-tight">
            One trusted identity. Scheduled online care.
          </h2>
          <div className="relative mt-8 grid gap-3 sm:grid-cols-2">
            {["Patient", "Doctor", "Pharmacist", "Administrator"].map(
              (role, index) => (
                <div
