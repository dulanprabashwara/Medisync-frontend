    ...
    <article className="flex flex-col rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-shadow hover:shadow-md h-full">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex size-14 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-teal-100 text-teal-900 font-bold uppercase">
            {doctor.profileImageUrl ? (
              ...
              <img
                ...
                alt={formatDoctorName(doctor.displayName)}
          ...
          <div>
            <h2 className="text-lg font-semibold text-slate-950 line-clamp-1">
              {formatDoctorName(doctor.displayName)}
            </h2>
            <p className="font-medium text-teal-700 text-sm line-clamp-1">
      ...
      <div className="mt-5 grid gap-3 text-sm flex-1">
        <div>
          ...
          <dd className="font-medium text-slate-900 line-clamp-1">
            {doctor.hospitalName}
          </dd>
          <dd className="text-slate-600 line-clamp-1 text-[13px]">
        ...
        {viewMode === "detail" && (
          <>
            <div>
              ...
              <dd className="font-medium text-slate-900 line-clamp-2">
